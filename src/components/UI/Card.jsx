      ...
      >
        ...
        <div className="px-5 pb-5">
          ...
          <div class="flex items-center mt-2.5 mb-5">
            ...
            <span class="bg-blue-100 text-blue-800 text-xs font-semibold px-0.05 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-">
              Web Development
            </span>
          </div>
          <div class="flex items-center justify-between">
            <span class="text-2xl font-bold text-gray-900 dark:text-black">
              Web Development
            </span>
            <a
              href="#"
